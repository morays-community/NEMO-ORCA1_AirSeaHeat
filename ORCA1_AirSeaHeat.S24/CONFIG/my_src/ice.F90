MODULE ice
   ...
   REAL(wp), PUBLIC ::   rn_oiht          !:   ocean to ice heat transfer coefficient
   ...
   ! for SPP routines
   REAL(wp), PUBLIC, ALLOCATABLE, SAVE, DIMENSION(:,:)   ::   rn_cio2d        !: 2d version of drag coefficient for oceanic stress
   REAL(wp), PUBLIC, ALLOCATABLE, SAVE, DIMENSION(:,:)   ::   rn_cnd_s2d      !: 2d version of thermal conductivity of the snow [W/m/K]
   REAL(wp), PUBLIC, ALLOCATABLE, SAVE, DIMENSION(:,:)   ::   rn_pnd_flush2d  !: 2d version of Pond flushing efficiency
   REAL(wp), PUBLIC, ALLOCATABLE, SAVE, DIMENSION(:,:)   ::   rn_hinew2d      !: 2d version of new ice's thickness
   REAL(wp), PUBLIC, ALLOCATABLE, SAVE, DIMENSION(:,:)   ::   rn_time_fl2d    !: 2d version of restoring time scale (flushing)
   REAL(wp), PUBLIC, ALLOCATABLE, SAVE, DIMENSION(:,:)   ::   rn_time_gd2d    !: 2d version of restoring time scale (gravity)
